$(document).ready(function(){
	...
	$('button#makeAddress').click(function(){
		...
		// remove this "return" to make your project work!!
		// return;

		// GREAT WORK!! I'm glad you implemented a function to handle your random number generation!
		// You can see how much it can streamline your code!!
		// Great work.
